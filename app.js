...
if (settings.heavy != true) {
  ...
  'getpeerinfo', 'gettxoutsetinfo', 'masternode', 'masternodelist', 'getguardiancount', 'getguardiancountonline']);
} else {
  ...
  */
  chaincoinapi.setAccess('only', ['getinfo', 'getstakinginfo', 'getnetworkhashps', 'getdifficulty', 'getconnectioncount',
    ...
    'getnextrewardestimate', 'getnextrewardwhenstr', 'getnextrewardwhensec', 'getsupply', 'gettxoutsetinfo', 'getguardiancount', 'getguardiancountonline']);
}
// view engine setup
