...
module.exports = {
  ...
  get_guardiancount: function(cb) {
    var uri = base_url + 'getguardiancount';
    request({uri: uri, json: true}, function (error, response, body) {
      return cb(body);
    });
  },

  get_guardiancountonline: function(cb) {
    var uri = base_url + 'getguardiancountonline';
    request({uri: uri, json: true}, function (error, response, body) {
      return cb(body);
    });
  },
  get_guardianonlinecount: function(cb) {
    var uri = base_url + 'getguardiancountonline';
    if (settings.baseType !== 'pivx')
      uri += '?filter=enabled';
    request({uri: uri, json: true}, function (error, response, body) {
